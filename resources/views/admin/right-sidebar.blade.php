        ...
        <div class="tab-content">
            <div id="tab-1" class="tab-pane active">
                <div class="sidebar-title">
                    ...
                    <small
                        ><i class="fa fa-tim"></i> You have 10 new
                        message.</small
                    >
                </div>
                ...
                <div>
                    ...
                    <div class="sidebar-message">
                        <a href="#">
                            ...
                            <div class="media-body">
                                Mevolved over the years, sometimes
                                by accident, sometimes on purpose
                                (injected humour and the like).
                                <br />
                                <small class="text-muted"
                                    >Yesterday 1:10 pm</small
                                >
                            </div>
                        </a>
                    </div>
            ...
            <div id="tab-2" class="tab-pane">
                <div class="sidebar-title">
                    ...
                    <small
                        ><i class="fa fa-tim"></i> You have 14
                        projects. 10 not completed.</small
                    >
                </div>
            ...
            <div id="tab-3" class="tab-pane">
                ...
                <div class="sidebar-content">
                    <h4>Settings</h4>
                    <div class="small">
                        I belive that. Lorem Ipsum is simply dummy
                        text of the printing and typesetting
                        industry. And typesetting industry. Lorem
                        Ipsum has been the industry's standard dummy
                        text ever since the 1500s. Over the years,
