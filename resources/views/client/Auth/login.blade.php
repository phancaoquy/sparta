            ...
            <div class="row justify-content-center" style="margin: 0; padding: 0;">
                <div class="col-12 col-xxl-11">
                    <div class="card border-light-subtle shadow-sm">
                        <div class="row g-0">
                            <div class="col-12 col-md-6 d-lg-block d-md-none d-sm-none ">
                                <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy"
                                    src="{{ asset('client/assets/images/form-img.jpg') }}"
                                                    ...
                                                    <div class="text-center mb-4">
                                                        <a href="#!">
                                                            <img src="{{ asset('client/assets/images/logo.png') }}"
                                                                alt="BootstrapBrain Logo" width="220" height="47">
                                                        </a>
                                                    </div>
                                                    <h4 class="text-center">Welcome back to Sparta!</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div
                                                    ...
                                                    <a href="{{ route('client.register') }}" class="link-secondary text-decoration-none">Create
                                                        new
                                                        account</a>
